...
const index = () => {
  ...
  return (
    <DashboardContainer name='Expense List' activeKey="19.1">
    <Card
      variant="borderless"
      styles={{body: {backgroundColor: "#F6F6F6"}, header: {backgroundColor: "#f6f6f6"}}}
      title={<div className='pt-5 pb-3 px-4'>
        <p className='text-[30px] text-[#050505] font-semibold'>Expense List</p>
        <p className='text-base text-[#616161] font-light'>Manage and track list of expense</p>
      </div>}
