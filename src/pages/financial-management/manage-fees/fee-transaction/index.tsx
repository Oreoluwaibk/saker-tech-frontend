...
const index = () => {
    ...
    const column: ColumnsType = [
       ...
       {
           key: "8",
           title: "View Student List of Fee History",
           dataIndex: "role",
  ...
  return (
    <DashboardContainer name='Fee Transaction of Class Wise' activeKey="21.5">
    <Card
      variant="borderless"
      styles={{body: {backgroundColor: "#F6F6F6"}, header: {backgroundColor: "#f6f6f6"}}}
      title={<div className='pt-5 pb-3 px-4'>
        <p className='text-[30px] text-[#050505] font-semibold'>Fee Transaction of Class Wise</p>
        <p className='text-base text-[#616161] font-light'>Manage and track list of transaction fee</p>
      </div>}
      extra={<div className='flex gap-4'>
        
        {/* <Button type="primary" className='!h-[54px] !min-w-[160px] !text-[#3E444C] !rounded-[5px] !font-semibold' icon={<PlusOutlined />} onClick={() => setAddExpense(true)}>Add Expense</Button> */}
      </div>}
    >
