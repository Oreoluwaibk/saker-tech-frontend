...
const index = () => {
  ...
  return (
    ...
    <TableCards 
      name='Bulk Promotion'
      description='Manage and Track List of Upgraded Student'
      ...
      extra={<div className='flex gap-4'>
        ...
        <Button type="primary" className='!h-[54px] !min-w-[160px] !text-[#3E444C] !rounded-[5px] !font-semibold' icon={<PlusOutlined />} >Student Bulk Uploader</Button>
      </div>}
    />
