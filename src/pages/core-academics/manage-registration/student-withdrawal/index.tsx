...
const index = () => {
  ...
  return (
    <>
    <TableCards 
      name='Student Withdrawn/ Inactive List'
      description='Manage and Track List of withdrawn/inactive student'
      title='Student Withdrawn/ Inactive List'
      activeKey='7.0'
      column={column}
      dataSource={courses}
      showFilter
      extra={<div className='flex gap-4'>
        ...
        <Button type="primary" className='!h-[54px] !min-w-[160px] !text-[#3E444C] !rounded-[5px] !font-semibold' icon={<PlusOutlined />} >Export To Excel</Button>
      </div>}
    />
