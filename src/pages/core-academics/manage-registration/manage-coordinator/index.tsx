...
const index = () => {
  ...
  return (
    ...
    <TableCards 
      ...
      description='Track student list of coordinators.'
      title='Coordinator List'
      activeKey='6.8'
      column={column}
      dataSource={courses}
      extra={<div className='flex gap-4'>
        <Button type="primary" className='!h-[54px] !min-w-[160px] !text-[#3E444C] !rounded-[5px] !font-semibold' icon={<PlusOutlined />} onClick={() => setAddAcademicYear(true)}>Add Coordinator</Button>
      </div>}
    />
