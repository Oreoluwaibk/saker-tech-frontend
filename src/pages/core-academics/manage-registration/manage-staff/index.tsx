...
const index = () => {
  ...
  return (
    ...
    <TableCards 
      name='Staff List'
      description='Manage and Monitor staff'
      title='Staff List'
      activeKey='6.0'
      column={column}
      dataSource={courses}
      extra={<div className='flex gap-4'>
        <Button type="primary" className='!h-[54px] !min-w-[160px] !text-[#3E444C] !rounded-[5px] !font-semibold' icon={<PlusOutlined />} onClick={() => setAddAcademicYear(true)}>Add Staff</Button>
      </div>}
    />
