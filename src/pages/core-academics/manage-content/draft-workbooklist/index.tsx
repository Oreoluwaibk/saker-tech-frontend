...
const index = () => {
      ...
      render: () => (
        <div className="flex gap-2">
          <Button
            ...
            style={{ border: 'none', padding: '2px', background: 'transparent', boxShadow: 'none' }}
          >
            <EyeOutlined />
          </Button>
          <Button
  ...
  return (
    <DashboardContainer name="Manage Draft Work book" activeKey="10.2">
      <Card
        variant="borderless"
        styles={{
        ...
        title={
          <div className="pt-5 pb-3 px-4 flex gap-3 flex-col">
            <div>
              <p className="text-[30px] text-[#050505] font-semibold">Draft WorkBook List</p>
              <p className="text-base text-[#616161] font-light">
                Manage and track lists of draft workbook
              </p>
            </div>
          </div>
        }
