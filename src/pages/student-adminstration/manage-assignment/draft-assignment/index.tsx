...
const Index = () => {
  ...
  return (
    <DashboardContainer name="Drafted Assignment" activeKey="28.2">
      <Card
        variant="borderless"
        styles={{
        ...
        title={
          <div className="pt-5 pb-3 px-4 flex gap-3 flex-col">
            <div>
              <p className="text-[30px] text-[#050505] font-semibold">Draft Assignment List</p>
              <p className="text-base text-[#616161] font-light">Manage and track lists of drafted assignment</p>
            </div>
          </div>
        }
