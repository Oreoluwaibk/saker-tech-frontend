...
const LearningLevelDetails = ({ open, onCancel }: modal) => {
  ...
  return (
    <Modal 
        title={<p className='text-lg font-medium'>Learning Level Details</p>}
        open={open}
        onCancel={onCancel}
    ...
    >
        <Form layout="vertical">
            <Row gutter={[15, 0]}>
                ...
                <Col lg={12} sm={24} xs={24}>
                    <FormItem label="Assessment Name" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input disabled placeholder="Select" />
                    </FormItem>
                </Col>

                <Col lg={12} sm={24} xs={24}>
                    <FormItem label="Assessment Use" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input disabled placeholder="Select" />
                    </FormItem>
                </Col>
                <Col lg={12} sm={24} xs={24}>
                ...
                <Col lg={12} sm={24} xs={24}>
                    <FormItem label="Negative Marking" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input disabled placeholder="Select" />
                    </FormItem>
                </Col>
                ...
                <Col lg={12} sm={24} xs={24}>
                    <FormItem label="Chapter" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input disabled placeholder="Select" />
                    </FormItem>
                </Col>

                <Col lg={12} sm={24} xs={24}>
                    <FormItem label="Concept" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input disabled placeholder="Select" />
                    </FormItem>
                </Col>
...
export default LearningLevelDetails