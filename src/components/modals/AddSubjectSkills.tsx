...
const AddSubjectSkill = ({ open, onCancel }: modal) => {
  return (
    <Modal 
        title={<p className='text-lg font-medium'>Add Subject Skill</p>}
        open={open}
        onCancel={onCancel}
    ...
    >
        <Form layout="vertical">
            <Row gutter={[15, 0]}>
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Subject Skill" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input 
...
export default AddSubjectSkill