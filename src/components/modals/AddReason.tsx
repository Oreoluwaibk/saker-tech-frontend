...
const AddReason = ({ open, onCancel }: modal) => {
  return (
    <Modal 
        title={<p className='text-lg font-medium'>Add Reason</p>}
        open={open}
        onCancel={onCancel}
        ...
        <Form layout="vertical">
            <Row gutter={[15, 0]}>
                <Col lg={24} sm={24} xs={24}>
                    <FormItem label="Reason Name" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
