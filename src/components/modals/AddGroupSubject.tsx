...
const AddGroupSubject = ({ open, onCancel }: modal) => {
  return (
    <Modal 
        title={<p className='text-lg font-medium'>Add Group Subject</p>}
        open={open}
        onCancel={onCancel}
        ...
        <Form layout="vertical">
            <Row gutter={[15, 0]}>
                <Col lg={24} sm={24} xs={24}>
                    <FormItem label="Add Group Subject" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input placeholder='Enter group subject'/>
                    </FormItem>
                </Col>
