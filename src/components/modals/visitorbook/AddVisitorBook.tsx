...
import { Button, Col, DatePicker, Form, Input, InputNumber, message, Modal, Row, Upload, UploadFile } from 'antd'
...
const AddVisitorBook = ({ open, onCancel }: modal) => {
  ...
  return (
    <Modal 
        title={<p className='text-lg font-medium'>Add Visitor Book</p>}
        open={open}
        onCancel={onCancel}
        ...
        <Form layout="vertical">
            <Row gutter={[15, 0]}>
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Purpose" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input 
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Phone" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <InputNumber 
                            min={0}
                            style={{width: "100%"}}
                        />
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="ID Card" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <InputNumber 
                            min={0}
                            style={{width: "100%"}}
                        />
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Number of Person" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <InputNumber 
                            min={0}
                            style={{width: "100%"}}
                        />
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="In Time" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <DatePicker style={{width: "100%"}} />
                    </FormItem>
                </Col>

                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Out Time" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <DatePicker style={{width: "100%"}} />
                    </FormItem>
                </Col>    
