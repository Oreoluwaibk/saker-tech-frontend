...
const AddPostalDispatc = ({ open, onCancel }: modal) => {
  ...
  return (
    <Modal 
        title={<p className='text-lg font-medium'>Add Postal Dispatch</p>}
        open={open}
        onCancel={onCancel}
        ...
        <Form layout="vertical">
            <Row gutter={[15, 0]}>
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="To Title" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input 
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="From Title" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input 
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Reference Number" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input 
...
export default AddPostalDispatc