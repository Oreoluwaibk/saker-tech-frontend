...
const AddDetails = ({ open, onCancel }: modal) => {
    ...
    >
         <Form layout="vertical">
            <Row gutter={[15, 0]}>
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Reference No." style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input 
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="To Address" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input 
