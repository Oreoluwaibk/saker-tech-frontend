...
const AddHostel = ({ open, onCancel }: modal) => {
  return (
     <Modal 
        ...
        <Form layout="vertical">
            <Row gutter={[15, 0]}>
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Hostel Name" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input 
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Hostel Type" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
