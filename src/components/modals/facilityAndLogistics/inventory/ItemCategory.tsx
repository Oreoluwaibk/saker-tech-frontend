...
const ItemCategory = ({ open, onCancel }: modal) => {
  return (
     <Modal 
        title={<p className='text-lg font-medium'>Add Item Category</p>}
        open={open}
        onCancel={onCancel}
        ...
        <Form layout="vertical">
            <Row gutter={[15, 0]}>
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Item Catergory Name" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input />
                    </FormItem>
                </Col>

                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Item Category Code" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input />
                    </FormItem>
                </Col>
