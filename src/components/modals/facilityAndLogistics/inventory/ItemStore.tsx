...
const ItemStore = ({ open, onCancel }: modal) => {
  return (
     <Modal 
        ...
        <Form layout="vertical">
            <Row gutter={[15, 0]}>
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Item Store Name" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input />
                    </FormItem>
                </Col>

                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Item Stock Code" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input />
                    </FormItem>
                </Col>
