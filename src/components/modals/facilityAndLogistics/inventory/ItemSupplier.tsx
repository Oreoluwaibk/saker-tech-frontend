...
const ItemSupplier = ({ open, onCancel }: modal) => {
  return (
     <Modal 
        title={<p className='text-lg font-medium'>Add Item Store</p>}
        open={open}
        onCancel={onCancel}
    ...
    >
        <Form layout="vertical">
            <Row gutter={[15, 0]}>
                ...
                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Contact Person Name" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input />
                    </FormItem>
                </Col>

                <Col lg={12} sm={12} xs={12}>
                    <FormItem label="Contact Person Phoner" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input />
                    </FormItem>
                </Col>

                <Col lg={24} sm={24} xs={24}>
                    <FormItem label="Contact Email Address" style={{fontWeight:"400"}} name="coverimage" rules={[{required: true}]}>
                        <Input />
                    </FormItem>
                </Col>
